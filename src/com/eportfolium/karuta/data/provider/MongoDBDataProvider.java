...
public class MongoDBDataProvider implements DataProvider {
    ...
    public Object postNode(Connection c, MimeType inMimeType, String parentNodeUuid,
                           String in, int userId, int groupId, boolean forcedUuid) throws Exception {
        // TODO Auto-generated method stub
        return null;
    }
    ...
    @Override
    public String[] getUsers(Connection c, int userId, String username, String firstname, String lastname, String email) {
        // TODO Auto-generated method stub
        return null;
    }
